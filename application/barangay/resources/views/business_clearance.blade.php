...
<body style="background-color: rgba(163, 157, 157, 0.37);">
    ...
    <header>
        <nav class="main-header navbar navbar-expand " style="background-color: #AA0F0A;">
            <div class="container-fluid flex-sm-row">
                ...
                <ul class="navbar-nav ">
                    <li class="nav-item">
                        <nobr class="nav-link text-white font-weight-bold"><span>ONLINE REQUEST FOR BUSINESS CLEARANCE</span></nobr>
                    </li>
                </ul>
                <ul class="navbar-nav ">
                    <li class="nav-item">
    ...
    <body>
        ...
        <form  id="yourForm" method="post" enctype="multipart/form-data" action="{{url('submit-business-request')}}" class="needs-validation" novalidate>
            ...
            <input type="hidden" name="request_type_name" value="BUS-CLR">
                ...
                <div class="shadow p-3 mb-3 bg-body rounded ">
                    ...
                    <div class="row my-3 ">
                        <div class="col-md-6 mb-2 text-center">
                            ...
                            <input name="business_name" id="business_name" class="form-control w-75 mx-auto d-block" value="" type="text" />
                        </div>
                        <div class="col-md-6 mb-2 text-center">
                            <p class="fs-6  mb-2 ">Business Address: <span class="text-danger">*</span></p>
                            <input name="business_address" id="business_address" class="form-control w-75 mx-auto d-block" value="" type="text" />
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row my-3 ">
                        <div class="col-md-4 mb-2">
                            ...
                            <select onchange="price_change()" name="request_description" id="applicationType" class="form-select form-control" aria-label="Default select example" required>
                                ...
                                <option value="SINGLE PROPRIETORSHIP (New)">SINGLE PROPRIETORSHIP (New)</option>
                                <option value="SINGLE PROPRIETORSHIP (Renewal)">SINGLE PROPRIETORSHIP (Renewal)</option>
                                <option value="CORPORATION (New)">CORPORATION (New)</option>
                                <option value="CORPORATION (Renewal)">CORPORATION (Renewal)</option>
                            </select>
                        </div>
                        <div class="col-md-4 mb-2">
