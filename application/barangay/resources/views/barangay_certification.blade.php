...
<body style="background-color: rgba(163, 157, 157, 0.37);">
    ...
    <header>
        <nav class="main-header navbar navbar-expand " style="background-color: #AA0F0A;">
            <div class="container-fluid flex-sm-row">
                ...
                <ul class="navbar-nav ">
                    <li class="nav-item">
                        <nobr class="nav-link text-white font-weight-bold"><span>ONLINE REQUEST FOR BARANGAY CERTIFICATION</span></nobr>
                    </li>
                </ul>
                <ul class="navbar-nav ">
                    <li class="nav-item">
    ...
    <body>
        ...
        <form id="yourForm" method="post" enctype="multipart/form-data" action="{{url('submit-request')}}" class="needs-validation" novalidate>
            ...
            <input type="hidden" name="request_type_name" value="BRGY-CERT">
                    ...
                    <div class="row my-3 ">
                        <div class="col-md-4 mb-2">
                            ...
                            <select onchange="price_change()" name="request_description" id="applicationType" class="form-select form-control" aria-label="Default select example" required>
                                ...
                                <option value="Transfer of residency and authority to transport personal belongings">Transfer of residency and authority to transport personal belongings</option>
                                <option value="Certificate to File Action">Certificate to File Action</option>
                                <option value="Certificate of Indigency">Certificate of Indigency</option>
                                <option value="Financial, Medical, Wake and Burial Assistance">Financial, Medical, Wake and Burial Assistance</option>
                                <option value="LMB Endorsement">LMB Endorsement</option>
                                <option value="Titling">Titling </option>
                                <option value="House Assessment">House Assessment</option>
                                <option value="Non-encroachment Certification">Non-encroachment Certification</option>
                                <option value="Lot Survey">Lot Survey</option>
                            </select>
                        </div>
                        <div class="col-md-4 mb-2">
    ...
    <script src="{{asset('js/barangay_certification.js')}}"></script>
    <script>
